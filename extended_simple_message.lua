...
do
	...
	-- constants
	--
	local DISSECTOR_VERSION              = "0.1.11"
	...
	local MSG_MIKADO_ACTION_TRIGGER      = 0xFDE8
	local MSG_MIKADO_STATUS              = 0xFDE9
	...
	local MOTO_MOTION_REPLY_SUBCODE_INVALID_DATA_ACCEL        = 3014
	local MOTO_MOTION_REPLY_SUBCODE_INVALID_DATA_INSUFFICIENT = 3015
	local MOTO_MOTION_REPLY_SUBCODE_INVALID_DATA_TIME         = 3016
	local MOTO_MOTION_REPLY_SUBCODE_INVALID_DATA_TOOLNO       = 3017
	...
	local MIK_VALID_FIELD_TYPE_TIME          = 0x01
	local MIK_VALID_FIELD_TYPE_MOTION_TYPE   = 0x02
	local MIK_VALID_FIELD_TYPE_TRAJ_PART     = 0x03
	local MIK_VALID_FIELD_TYPE_LAST_PT_OF_TRAJ_PART = 0x04
	local MIK_VALID_FIELD_TYPE_POSITION      = 0x05
	local MIK_VALID_FIELD_TYPE_VELOCITY      = 0x07


	local MIKADO_MOTION_TYPE_INVALID = 0
	local MIKADO_MOTION_TYPE_JOINT   = 1
	local MIKADO_MOTION_TYPE_LINEAR  = 2
    local MIKADO_MOTION_TYPE_SPLINE  = 3
	local MIKADO_MOTION_TYPE_ARC     = 4
	local MIKADO_MOTION_TYPE_APPROXIMATE = 5

	local MIKADO_TRAJECTORY_TYPE_INVALID = 0
	local MIKADO_TRAJECTORY_TYPE_REGULAR = 1
	local MIKADO_TRAJECTORY_TYPE_PICK = 2

	local MIKADO_TRAJECTORY_PART_INVALID = 0
	local MIKADO_TRAJECTORY_PART_PRE_CALIB = 1
    local MIKADO_TRAJECTORY_PART_CALIBRATION = 2
	local MIKADO_TRAJECTORY_PART_REGULAR = 3
	local MIKADO_TRAJECTORY_PART_APPROACH = 4
	local MIKADO_TRAJECTORY_PART_GRASP = 5
	local MIKADO_TRAJECTORY_PART_EXTRACT = 6
	local MIKADO_TRAJECTORY_PART_RETRACT = 7

	local MIKADO_IS_NOT_LAST_PT_OF_TRAJ_PART = 0
	local MIKADO_IS_LAST_PT_OF_TRAJ_PART = 1
	...
	local pkt_types_str = {
		...
		[MSG_MIKADO_ACTION_TRIGGER    ] = "Mikado Action Trigger",
	...
	local mik_valid_field_type_str = {
		[VALID_FIELD_TYPE_TIME        ] = "Time",
		[VALID_FIELD_TYPE_POSITION    ] = "Position",
		[VALID_FIELD_TYPE_VELOCITY    ] = "Velocity"
	}
	...
	local mikado_motion_type_str = {
		[MIKADO_MOTION_TYPE_INVALID                 ] = "Invalid",
		[MIKADO_MOTION_TYPE_JOINT                   ] = "Joint",
		[MIKADO_MOTION_TYPE_LINEAR                  ] = "Linear",
		[MIKADO_MOTION_TYPE_SPLINE                  ] = "Spline",
		[MIKADO_MOTION_TYPE_ARC                     ] = "Arc",
		[MIKADO_MOTION_TYPE_APPROXIMATE             ] = "Approximate"
	}

	local mikado_trajectory_type_str = {
		[MIKADO_TRAJECTORY_TYPE_INVALID             ] = "Invalid",
		[MIKADO_TRAJECTORY_TYPE_REGULAR             ] = "Regular",
		[MIKADO_TRAJECTORY_TYPE_PICK                ] = "Pick"
	}

	local mikado_trajectory_part_str = {
		[MIKADO_TRAJECTORY_PART_INVALID             ] = "Invalid",
		[MIKADO_TRAJECTORY_PART_PRE_CALIB           ] = "Precalibration",
		[MIKADO_TRAJECTORY_PART_CALIBRATION         ] = "Calibration",
		[MIKADO_TRAJECTORY_PART_REGULAR             ] = "Regular",
		[MIKADO_TRAJECTORY_PART_APPROACH            ] = "Approach",
		[MIKADO_TRAJECTORY_PART_GRASP               ] = "Grasp",
		[MIKADO_TRAJECTORY_PART_EXTRACT             ] = "Extract",
		[MIKADO_TRAJECTORY_PART_RETRACT             ] = "Retract"
	}

	local mikado_last_pt_of_traj_part_str = {
		[MIKADO_IS_NOT_LAST_PT_OF_TRAJ_PART         ] = "False", 
		[MIKADO_IS_LAST_PT_OF_TRAJ_PART             ] = "True",
	}
	...
	-- protocol fields: MIKADO_JOINT_TRAJ_PT_FULL
	f.mikjtptf_robotid  = ProtoField.int32("simplemessage.mikjtptf.rid"     , "Robot ID"       , base.DEC, nil          , nil                          , "Robot identifier")
	f.mikjtptf_seq_nr   = ProtoField.int32("simplemessage.mikjtptf.seq"     , "Sequence Number", base.DEC, nil          , nil                          , "Index of point in trajectory")
	f.mikjtptf_vf       = ProtoField.uint8("simplemessage.mikjtptf.vf"      , "Valid Fields"   , base.HEX, nil          , nil                          , "Fields that contain valid data")
	f.mikjtptf_vf_time  = ProtoField.uint8("simplemessage.mikjtptf.vf.time" , "Time         "  , base.DEC, in_valid_str , MIK_VALID_FIELD_TYPE_TIME        , "Validity of time field")
	f.mikjtptf_vf_mt  = ProtoField.uint8("simplemessage.mikjtptf.vf.mt" , "Motion Type         "  , base.DEC, in_valid_str , MIK_VALID_FIELD_TYPE_MOTION_TYPE        , "Validity of motion type field")
	f.mikjtptf_vf_tp   = ProtoField.uint8("simplemessage.mikjtptf.vf.tp"  , "Trajectory Part     "  , base.DEC, in_valid_str , MIK_VALID_FIELD_TYPE_TRAJ_PART    , "Validity of Trajectory Part field")
	f.mikjtptf_vf_lpotp   = ProtoField.uint8("simplemessage.mikjtptf.vf.lpotp"  , "Last part of trajectory part     "  , base.DEC, in_valid_str , MIK_VALID_FIELD_TYPE_LAST_PT_OF_TRAJ_PART   , "Validity of last part of trajectory part field")
	f.mikjtptf_vf_vel   = ProtoField.uint8("simplemessage.mikjtptf.vf.vel"  , "Velocity     "  , base.DEC, in_valid_str , MIK_VALID_FIELD_TYPE_VELOCITY    , "Validity of velocity data")
	f.mikjtptf_vf_pos = ProtoField.uint8("simplemessage.mikjtptf.vf.pos", "Position "  , base.DEC, in_valid_str , MIK_VALID_FIELD_TYPE_POSITION, "Validity of position data")
	f.mikjtptf_time     = ProtoField.float("simplemessage.mikjtptf.time"    , "Time"           , "Timestamp for data (seconds, optional)")
	f.mikjtptf_motion_type  = ProtoField.int32("simplemessage.mikjtptf.mt"     , "Motion Type"       , base.DEC, mikado_motion_type_str          , nil                          , "Motion Type")
	f.mikjtptf_traj_part  = ProtoField.int32("simplemessage.mikjtptf.tp"     , "Trajectory Part"       , base.DEC, mikado_trajectory_part_str          , nil                          , "Trajectory Part")
	f.mikjtptf_last_pt_of_traj_part  = ProtoField.int32("simplemessage.mikjtptf.lpt"     , "Is last point of trajectory part"       , base.DEC, mikado_last_pt_of_traj_part_str          , nil                          , "Is last point of trajectory part")

	-- protocol fields: MIKADO_TRAJECTORY
	f.miktraj_trajtype = ProtoField.int32("simplemessage.miktraj.trajtype", "Trajectory Type", base.DEC, mikado_trajectory_type_str       , nil                          , "Trajectory Type")
	f.miktraj_nrofpts = ProtoField.int32("simplemessage.miktraj.nrofpts", "Number of Points", base.DEC, nil         , nil                          , "Number of Points")
	f.miktraj_pts      = ProtoField.uint8("simplemessage.miktraj.pts"      , "Points"   , base.DEC, nil          , nil                          , "Points")
	f.miktraj_trajpt      = ProtoField.uint8("simplemessage.miktraj.trajpt"      , "Trajectory Point"   , base.DEC, nil          , nil                          , "Trajectory Point")


	-- protocol fields: MIKADO_ACTION_TRIGGER
	f.mikat_action_id = ProtoField.int32("simplemessage.mikat.action_id", "Action ID", base.DEC, nil       , nil                          , "Action ID")
	f.mikat_camera_id = ProtoField.int32("simplemessage.mikat.camera_id", "Camera ID", base.DEC, nil         , nil                          , "Camera ID")
	f.mikat_product_id = ProtoField.int32("simplemessage.mikat.product_id"      , "Product ID"   , base.DEC, nil          , nil                          , "Product ID")
	f.mikat_gripper_id      = ProtoField.int32("simplemessage.mikat.gripper_id"      , "Gripper ID"   , base.DEC, nil          , nil                          , "Gripper ID")
	f.mikat_roi_id      = ProtoField.int32("simplemessage.mikat.roi_id"      , "ROI ID"   , base.DEC, nil          , nil                          , "ROI ID")
	f.mikat_pick_zone_id      = ProtoField.int32("simplemessage.mikat.pick_zone_id"      , "Pick Zone ID"   , base.DEC, nil          , nil                          , "Pick Zone ID")
	...
	local function add_intf(buf, tree, offset, len, text)
		local val = pref_int(buf, offset, len)
		return tree:add(buf(offset, len), text)
			   :append_text(string.format(": %d", val))
	end
	...
	-- array of N ints
	--
	local function disf_int_array(buf, pkt, tree, offset, array_sz, text, item_fmt)
		--
		local offset_ = offset
		local lt = tree

		--
		local ia_tree = lt:add(buf(offset_, array_sz * 4), text)

		for i = 0, (array_sz - 1) do
			local label = string.format("%s%d", item_fmt, i)
			add_intf(buf, ia_tree, offset_, 4, label)
			offset_ = offset_ + 4
		end

		local tlen = offset_ - offset
		ia_tree:set_len(tlen)
		return (tlen)
	end
	...
	--
	-- MIKADO_JOINT_TRAJ_PT_FULL
	--
	local function disf_mikado_joint_traj_point_full(buf, pkt, tree, offset)
		--
		local offset_ = offset
		local lt = tree
		...
		-- traj_part
		pref_tree_add(body_tree, f.mikjtptf_traj_part, buf, offset_, 4)
		offset_ = offset_ + 4

		-- is_last_pt_of_traj_part
		pref_tree_add(body_tree, f.mikjtptf_last_pt_of_traj_part, buf, offset_, 4)
		offset_ = offset_ + 4
	...
	--
	-- MIKADO_JOINT_TRAJ_PT_FULL_NO_HEADER
	--
	local function disf_mikado_joint_traj_point_full_no_header(buf, pkt, tree, offset)
		--
		local offset_ = offset
	...
	-- MIKADO_TRAJECTORY
	--
	local function disf_mikado_trajectory(buf, pkt, tree, offset)
		--
		local offset_ = offset
		local lt = tree
		...
		-- trajectory length
		local traj_length = pref_uint(buf, offset_, 4)
		pref_tree_add(body_tree, f.miktraj_nrofpts, buf, offset_, 4)
		offset_ = offset_ + 4

		-- trajectory type
		pref_tree_add(body_tree, f.miktraj_trajtype, buf, offset_, 4)
		offset_ = offset_ + 4

		--local pts_tree = pref_tree_add(body_tree, f.miktraj_pts, buf, offset_, 4)

		local pts_tree = body_tree:add(buf(offset_, 0), "Points")

		for i = 0, traj_length-1 do 
			point_tree = pts_tree:add(buf(offset_, 0), "Mikado Trajectory Point #" .. i)
			offset_ = offset_ + disf_mikado_joint_traj_point_full_no_header(buf, pkt, point_tree, offset_)
		end
	...
	--
	-- MIKADO_ACTION_TRIGGER
	--
	local function disf_mikado_action_trigger(buf, pkt, tree, offset)
		--
		local offset_ = offset
		local lt = tree
		...
		-- action id
		pref_tree_add(body_tree, f.mikat_action_id, buf, offset_, 4)
		offset_ = offset_ + 4

		-- camera id
		pref_tree_add(body_tree, f.mikat_camera_id, buf, offset_, 4)
		offset_ = offset_ + 4

		-- product id
		pref_tree_add(body_tree, f.mikat_product_id, buf, offset_, 4)
		offset_ = offset_ + 4

		-- gripper id
		pref_tree_add(body_tree, f.mikat_gripper_id, buf, offset_, 4)
		offset_ = offset_ + 4

		-- roi id
		pref_tree_add(body_tree, f.mikat_roi_id, buf, offset_, 4)
		offset_ = offset_ + 4
		
		-- pick zone id
		pref_tree_add(body_tree, f.mikat_pick_zone_id, buf, offset_, 4)
		offset_ = offset_ + 4
		
		-- additional int arguments
		offset_ = offset_ + disf_int_array(buf, pkt, body_tree, offset_, 10, "Additional Int Arguments", "I")

		-- additional float arguments
		offset_ = offset_ + disf_float_array(buf, pkt, body_tree, offset_, 10, "Additional Real Arguments", "R%d")
	...
	--
	-- MIKADO_ROBOT_MODEL_INFO
	--
	local function disf_mikado_robot_model_info(buf, pkt, tree, offset)
		--
		local offset_ = offset
		local lt = tree
		...
		-- action id
		pref_tree_add(body_tree, f.mikrmi_action_id, buf, offset_, 4)
		offset_ = offset_ + 4

		-- software version
		pref_tree_add(body_tree, f.mikrmi_software_version, buf, offset_, 4)
		offset_ = offset_ + 4
		
		-- Joint Limits Min
		offset_ = offset_ + disf_float_array(buf, pkt, body_tree, offset_, 10, "Joint Limits Min", "J%d")

		-- Joint Limits Max
		offset_ = offset_ + disf_float_array(buf, pkt, body_tree, offset_, 10, "Joint Limits Max", "J%d")
		...
		if remaining_len > 0 then
			...
			body_tree:add(char_buf, "Robot Model: " .. str)
